...
extern bool userstats_add(PGconn *conn, INTRANSIENT *in_poolinstance, char *elapsed, char *username,
			  INTRANSIENT *in_workername, char *hashrate,
			  char *hashrate5m, char *hashrate1hr,
			  char *hashrate24hr, bool idle, bool eos, char *by,
			  char *code, char *inet, tv_t *cd, K_TREE *trf_root);
extern bool workerstats_add(PGconn *conn, INTRANSIENT *in_poolinstance, char *elapsed, char *username,
			    INTRANSIENT *in_workername, char *hashrate,
			    char *hashrate5m, char *hashrate1hr,
